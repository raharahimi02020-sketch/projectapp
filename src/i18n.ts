...
const staticTranslations: Record<AppLanguage, Record<string, string>> = {
  ...
  fa: {
    ...
    V2Ray: 'وی‌تو‌ری',
    OpenVPN: 'اوپن‌وی‌پی‌ان',
    'سرویس\u200cهای پیشنهادی': 'سرویس\u200cهای پیشنهادی',
    'Deliver service': 'ارسال سرویس',
    'Confirm & deliver service': 'تایید و ارسال سرویس',
    'Order confirmed — service sent to user': 'سفارش تایید شد — سرویس ارسال شد',
    'Service delivered': 'سرویس ارسال شده',
    'یوزر / پسورد': 'یوزر / پسورد',
    'Stay tuned': 'دنبال کنید',
    ...
    'Order rejected': 'سفارش رد شد',
    'Order deleted': 'سفارش حذف شد',
    'Confirm reject?': 'سفارش رد بشه؟',
    'Confirm delete?': 'سفارش حذف بشه؟',
    'Order was cancelled by user': 'این سفارش توسط کاربر لغو شده',
    purchase: 'خرید',
    renew: 'تمدید',
    upgrade: 'ارتقا',
  ...
  ar: {
    ...
    'Confirm reject?': 'رفض الطلب؟',
    'Confirm delete?': 'حذف الطلب؟',
    'Order was cancelled by user': 'تم إلغاء هذا الطلب من قبل المستخدم',
    purchase: 'شراء',
    renew: 'تجديد',
    upgrade: 'ترقية',
    trial: 'تجريبي',
